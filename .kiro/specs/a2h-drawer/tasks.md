...
- [x] 1. 開発基盤（依存関係・スタイル・テスト環境）を整備する
- [x] 1.1 ライブラリとして必要な依存関係と公開形態を整える
...
- [x] 1.2 Tailwind CSS v4 で iOS ライクな見た目・アニメーションの土台を用意する
...
- [x] 1.3 Bun のテスト実行基盤を整え、DOM テストが回る状態にする
...
- [x] 1.4 `/example` のベースを作り、メタデータとメディアを用意する
