    ...
    <Drawer open={controlledOpen !== undefined ? controlledOpen : isOpen} onOpenChange={handleOpenChange}>
      <DrawerContent
        className={cn(
          ...
          theme === "ios" && "glass-morphism rounded-t-3xl",
          theme === "material" && "glass-light rounded-t-2xl",
          className,
        )}
      >
        <DrawerHeader className="text-center px-6 pt-6">
          ...
          <DrawerTitle
            className={cn("text-xl font-semibold tracking-tight", theme === "ios" && "font-system text-foreground/90")}
          >
            Add to Home Screen
          </DrawerTitle>
        ...
        <div className="px-6 pb-2">
          ...
          <div className="flex items-center space-x-4 mb-8">
            ...
            <div className="flex-1 min-w-0">
              <h3 className="text-2xl font-bold text-foreground/90 truncate font-system">{finalAppName}</h3>
          ...
          {/* Demo Video */}
          {showDemoVideo && (
            <div className="mb-8 rounded-3xl overflow-hidden glass-light">
              <div className="aspect-video flex items-center justify-center text-muted-foreground">
                <div className="text-center">
                  <div className="w-16 h-16 rounded-2xl glass-medium flex items-center justify-center mb-3 mx-auto">
          ...
          <div className="space-y-4 mb-8">
            <div className="flex items-start space-x-4">
              <div className="flex-shrink-0 w-8 h-8 rounded-2xl glass-medium flex items-center justify-center">
        ...
        <DrawerFooter className="px-6 pb-8 pt-4">
          {isInstallable && installPrompt && (
            <Button
              ...
              className={cn(
                "w-full liquid-button text-white font-semibold py-4 text-base",
